...
Example usage:
  python object_detection/dataset_tools/create_oid_tf_record.py \ xxxx
    --input_annotations_csv=/path/to/input/annotations-human-bbox.csv \xxxxx
    --input_images_directory=/path/to/input/image_pixels_directory \xxxx
    --input_label_map=/path/to/input/labels_bbox_545.labelmap \xxxxx
    --output_tf_record_path_prefix=/path/to/output/prefix.tfrecordxxxxx
...
def main(_):
  ...
  with contextlib2.ExitStack() as tf_record_close_stack:
    ...
    for counter, image_data in enumerate(all_annotations.groupby('ImageID')):
      ...
      image_path = os.path.join(FLAGS.input_images_directory, str(image_id) + '.jpg')
